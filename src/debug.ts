...
export const writeMap = (map: RawSourceMap, context: Context, sourceContent: string, generatedContent: string ) => {
  ...
  fs.writeFileSync(path.join(baseDir, context.destFilename + '.map'), JSON.stringify(map))
}
